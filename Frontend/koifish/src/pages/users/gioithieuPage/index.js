    ...
    return (
        <div className="container">
            <article className="gioithieu-container">
                ...
                <section className="gioithieu-container__section">
                    <p>
                        1. <b>Tư vấn phong thủy toàn diện</b>: Chúng tôi sẽ đến tận nơi để khảo sát không gian và đưa ra giải pháp về vị trí, hướng đặt hồ cá Koi phù hợp với ngũ hành, âm dương và mệnh của gia chủ.<br />
                        2. <b>Thiết kế hồ cá Koi theo phong thủy</b>: Mỗi thiết kế của chúng tôi đều dựa trên những nguyên tắc phong thủy truyền thống, đảm bảo không gian hồ cá hài hòa với môi trường xung quanh, từ đó thu hút năng lượng tích cực.<br />
                        3. <b>Lựa chọn và phối giống cá Koi</b>: Cá Koi có nhiều loại với màu sắc và hình dáng khác nhau, mỗi loại đều mang một ý nghĩa phong thủy riêng. Chúng tôi sẽ giúp bạn lựa chọn những giống cá phù hợp, cân bằng ngũ hành và tăng cường tài vận.<br />
                        4. <b>Bảo dưỡng và chăm sóc hồ cá</b>: Ngoài việc thiết kế và thi công, chúng tôi còn cung cấp dịch vụ bảo dưỡng định kỳ, đảm bảo hồ cá Koi luôn trong trạng thái tốt nhất, cả về mặt phong thủy lẫn sức khỏe của cá.
                    </p>
                ...
                <section className="gioithieu-container__section">
                    <p>
                        1. <b>Kiến thức chuyên sâu về phong thủy</b>: Với nhiều năm kinh nghiệm, chúng tôi hiểu rõ các nguyên tắc phong thủy và cách áp dụng chúng trong thiết kế hồ cá Koi.<br />
                        2. <b>Thiết kế độc đáo và cá nhân hóa</b>: Mỗi dự án đều được tùy chỉnh sao cho phù hợp với không gian, sở thích và vận mệnh của gia chủ.<br />
                        3. <b>Chất lượng và uy tín</b>: Chúng tôi luôn sử dụng các vật liệu và cá giống chất lượng cao, đảm bảo hồ cá Koi của bạn không chỉ đẹp mà còn bền vững theo thời gian.<br />
